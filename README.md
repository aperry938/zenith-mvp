...
7. **Heuristic coaching** → rule-based corrections AND positive reinforcement for all 10 poses with varied coaching text, correction vectors, and server-side debounce
8. **Pose sequencing** → 4 guided flows (Warrior, Balance, Strength, Complete) with per-pose hold timers, auto-progression, and oracle-triggered analysis
...
| Guided sequences | 4 yoga flows (Warrior, Balance, Strength, Complete) |
