# === ZENith MVP - Final Version w/ 10 Poses ===
...
# --- THIS LIST IS NOW CORRECTED TO 10 POSES ---
pose_names = ['Chair', 'Crescent Lunge', 'Downward Dog', 'Extended Side Angle', 'High Lunge', 
    ...
    def transform(self, frame):
        ...
        if results.pose_landmarks:
            try:
                ...
                angles = {"l_knee": calculate_angle(coords[mp_pose.PoseLandmark.LEFT_HIP], coords[mp_pose.PoseLandmark.LEFT_KNEE], coords[mp_pose.PoseLandmark.LEFT_ANKLE]),
                ...
                for joint, angle in angles.items():
                    joint_name = joint.split('_')[1].upper()
                    ...
                    cv2.putText(image_bgr, str(int(angle)), coord, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 0), 2, cv2.LINE_AA)
            except Exception as e:
                current_pose = "Processing..."

        score_color = (0, 0, 255);
        if quality_score > 85: score_color = (0, 255, 0)
        elif quality_score > 60: score_color = (0, 255, 255)
        mp_drawing.draw_landmarks(image_bgr, results.pose_landmarks, mp_pose.POSE_CONNECTIONS, mp_drawing.DrawingSpec(color=(245,117,66), thickness=2, circle_radius=2), mp_drawing.DrawingSpec(color=(245,66,230), thickness=2, circle_radius=2))
...
webrtc_streamer(key="zenith-mvp-final", video_processor_factory=VideoTransformer, rtc_configuration={"iceServers": [{"urls": ["stun:stun.l.google.com:19302", "stun:stun1.l.google.com:19302"]}]}, media_stream_constraints={"video": True, "audio": False})
